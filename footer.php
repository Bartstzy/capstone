<footer class="bg-darkblue text-white py-2" style="background-color: #002147;">
    <div class="container">
        <div class="row">
            <div class="col-md-6 mb-2">
                <h6 class="mb-1">Barangay Poblacion South</h6>
                <small>Solano, Nueva Vizcaya</small><br>
                <small><i class="fas fa-phone me-2"></i> <a href="tel:+63781234567" class="text-white text-decoration-none">(078) 123-4567</a></small><br>
            ...
            <div class="col-md-6 text-md-end d-flex flex-column justify-content-center">
                ...
                <small>Developed by eFindSys2.0</small>
            </div>
        </div>
    </div>
</footer>
